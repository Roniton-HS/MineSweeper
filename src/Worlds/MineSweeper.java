...
public class MineSweeper extends Worlds {
    ...
    private final BufferedImage bomb = ImageLoader.loadImage("/bomb.png");
    private final BufferedImage flag = ImageLoader.loadImage("/flag.png");

    private void loadFont() {
        InputStream is = getClass().getResourceAsStream("/Recursive Bold.ttf");
        try {
            assert is != null;
